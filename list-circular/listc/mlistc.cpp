/* Program   : mlistc.cpp */
/* Deskripsi : file DRIVER modul list circular berkait */
...
void header(){
	system("cls");
	cout << "---------------------------------------------------" << endl;
	cout << "|            TUGAS ADT LIST CIRCULAR              |" << endl;
	cout << "---------------------------------------------------" << endl;
...
int main()
{
	...
	/* program utama */
	system("cls");
	CreateList(&L1); CreateList(&L2); CreateList(&L3); CreateList(&Lt);
	menu:
	header();
	cout << "\nL1: "; Printinfo(L1);
	cout << "\nL2: "; Printinfo(L2);
	...
	cout << "[20] Menyalin List tanpa Alokasi ke List Lt" << endl;
	cout << "[21] Menyalin List dengan Alokasi ke List Lt" << endl;
	cout << "[22] Menghasilkan List Hasil Penyalinan List Lain ke List Lt" << endl;
	cout << "[23] Menyambung List tanpa Alokasi ke List Lt" << endl;
	cout << "[24] Menyambung List dengan Alokasi ke List Lt" << endl;
	...
	switch(pilihan){
		...
		case 23:
			header();
			cout << "\n-- Menyambung List tanpa Alokasi ke List Lt --\n" << endl;
		...
		case 24:
			header();
			cout << "\n-- Menyambung List dengan Alokasi ke List Lt --\n" << endl;
			cout << "Pilih List Pertama:\n" << endl;
			cout << "1. L1\n2. L2\n3. L3" << endl;
			cout << "\nInput Pilihan: "; cin >> pilihan;
			cout << endl;
